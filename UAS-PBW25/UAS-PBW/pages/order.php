...
<body class="bg-gray-100">
    ...
    <header class="bg-red-600 text-white py-4 shadow-md sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-8">
                ...
                <a href="explore.php" class="text-red-100 font-medium hover:text-white transition duration-300">Jelajahi
                    Mobil</a>
                <a href="about_us.html"
                    class="text-red-100 font-medium hover:text-white transition duration-300">Tentang
                    Kami</a>
            </nav>
    ...
    <script>
        ...
        function updatePriceDisplay() {
            ...
            const total = basePriceTotal + additionalPrice + locationPrice;
